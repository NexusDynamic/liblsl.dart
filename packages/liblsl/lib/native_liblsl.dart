...
lsl_outlet lsl_create_outlet_ex(
  ...
  return _lsl_create_outlet_ex(info, chunk_size, max_buffered, flags.value);
}
...
lsl_channel_format_t lsl_get_channel_format(lsl_streaminfo info) {
  return lsl_channel_format_t.fromValue(_lsl_get_channel_format(info));
}
