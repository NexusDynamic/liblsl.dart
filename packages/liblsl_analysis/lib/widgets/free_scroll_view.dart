...
/// From: https://stackoverflow.com/a/67875198/570122 (@dade.sliep).
...
class _FreeScrollViewState extends State<FreeScrollView> {
  ...
  void _handleDragDown(DragDownDetails details) {
    _horizontalHold = _horizontalController.position.hold(
      () => _horizontalHold = null,
    );
    _verticalHold = _verticalController.position.hold(
      () => _verticalHold = null,
    );
  }

  void _handleDragStart(DragStartDetails details) {
    _horizontalDrag = _horizontalController.position.drag(
      details,
      () => _horizontalDrag = null,
    );
    _verticalDrag = _verticalController.position.drag(
      details,
      () => _verticalDrag = null,
    );
  }
