...
class DataStreamConnected extends DataStreamEvent {
  final String sourceId;

  DataStreamConnected(String streamId, this.sourceId)
    : super(streamId, DateTime.now());
}

class DataStreamDisconnected extends DataStreamEvent {
  final String streamAddress;

  DataStreamDisconnected(String streamId, this.streamAddress)
    : super(streamId, DateTime.now());
}
