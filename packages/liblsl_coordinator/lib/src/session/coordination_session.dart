...
sealed class SessionEvent {
  ...
  const SessionEvent(this.sessionId, this.timestamp);
}
...
class RoleChanged extends SessionEvent {
  ...
  RoleChanged(String sessionId, this.oldRole, this.newRole, this.reason) : super(sessionId, DateTime.now());
}
...
class TopologyChanged extends SessionEvent {
  ...
  TopologyChanged(String sessionId, this.oldTopology, this.newTopology) : super(sessionId, DateTime.now());
}