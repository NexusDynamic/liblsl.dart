...
class LSLTransportFactory implements TransportFactoryInterface {
  ...
  static LSLTransportFactory get instance => _instance ??= LSLTransportFactory._();
  ...
  Future<config.SessionResult> createSession(config.SessionConfig sessionConfig) async {
    ...
    try {
      ...
      final networkSession = await lsl_factory.LSLNetworkFactory.instance.createNetwork(
